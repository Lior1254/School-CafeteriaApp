...
public class UserData implements Serializable
{
    ...
    public UserData(String uid, boolean darkMode, boolean notificationsEnabled)
    {
        this.uid = uid;
    ...
    public UserData(String uid, List<Order> ordersHistory, List<Product> favoriteProducts,
