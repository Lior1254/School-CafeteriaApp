...
// בתוך OrdersFragment.java, החלף את פונקציית loadDummyData() בזו:
    private void loadDummyData() {
        ...
        orderList.add(new Order("1024", "ארוחת ריב, צ'יפס, קולה זירו", 77.00, 1, "התקבלה", "12:45", "12:40", "12:35"));
        orderList.add(new Order("1025", "פיצה מרגריטה", 55.00, 2, "בהכנה", "13:00", "12:55", "12:48"));
        orderList.add(new Order("1026", "סלט קיסר, מים", 48.50, 3, "מוכנה לאיסוף", "13:15", "13:10", "13:02"));
        orderList.add(new Order("1027", "קפה הפוך ומאפה", 24.00, 4, "נאספה", "13:20", "13:18", "13:15"));
    }
